...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(1,1)=2; nzij_pred(1,2)=4;
  nzij_pred(2,1)=3; nzij_pred(2,2)=4;
  nzij_pred(3,1)=4; nzij_pred(3,2)=4;
  nzij_pred(4,1)=6; nzij_pred(4,2)=5;
  ...
  nzij_current(18,1)=5; nzij_current(18,2)=6;
  nzij_fwrd = zeros(5, 2, 'int32');
  nzij_fwrd(1,1)=1; nzij_fwrd(1,2)=1;
  nzij_fwrd(2,1)=1; nzij_fwrd(2,2)=2;
  nzij_fwrd(3,1)=1; nzij_fwrd(3,2)=3;
  nzij_fwrd(4,1)=1; nzij_fwrd(4,2)=5;
  nzij_fwrd(5,1)=1; nzij_fwrd(5,2)=6;
end
